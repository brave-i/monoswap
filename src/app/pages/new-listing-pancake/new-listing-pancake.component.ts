...
@Component({
  selector: 'app-new-tokens-pancake',
  templateUrl: './new-listing-pancake.component.html',
  styleUrls: ['./new-listing-pancake.component.scss'],
})
export class NewListingPancakeComponent implements OnInit, OnDestroy {
  ...
  private fetchData() {
    this.tokenService
      .getPancakeTokens(this.currentPairs)
      .pipe(
        tap((res) => {
          // console.log(res);
          if (
