...
@Component({
  ...
  templateUrl: './hot-pairs-listing.component.html',
  styleUrls: ['./hot-pairs-listing.component.scss'],
})
export class HotPairsListingComponent implements OnInit {
  sub: Subscription;
  hotpairs: any[] = [];
  isAuth: boolean;
  ...
  ngOnInit(): void {
    this.etherService.connectedAddress$.subscribe((accountid) => {
      ...
      this.historicSercice
        .gethotPair('12', this.pageSize, 0, accountid)
        .pipe(
          tap((res) => {
            // console.log(res);
          })
